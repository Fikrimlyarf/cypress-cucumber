...
When('looping data', () => {
    data.list.forEach((go) => {
        ...
        cy.get('[data-cy="agenda_kegiatan.6.waktu_mulai"]').type(go.tglawal_presentasiproposal)
        cy.get('[data-cy="agenda_kegiatan.6.waktu_selesai"]').type(go.tglakhir_presentasiproposal)
        ...
        cy.get('[data-cy="agenda_kegiatan.10.waktu_mulai"]').type(go.tglawal_progres)
        cy.get('[data-cy="agenda_kegiatan.10.waktu_selesai"]').type(go.tglakhir_progres)
        ...
        cy.get('[data-cy="agenda_kegiatan.12.waktu_mulai"]').type(go.tglawal_presentasioutput)
        cy.get('[data-cy="agenda_kegiatan.12.waktu_selesai"]').type(go.tglakhir_presentasioutput)
