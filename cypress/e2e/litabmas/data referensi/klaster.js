...
When('looping data', () => {
    data.list.forEach((go) => {
        ...
        cy.wait(3000);
        cy.get('#form-control-agenda_kegiatan\\.1\\.waktu_mulai').type(go.tglawal_daftar)
        cy.get('#form-control-agenda_kegiatan\\.1\\.waktu_selesai').type(go.tglakhir_daftar)
        cy.get('#form-control-agenda_kegiatan\\.2\\.waktu_mulai').type(go.tglawal_reviewadmin)
        cy.get('#form-control-agenda_kegiatan\\.2\\.waktu_selesai').type(go.tglakhir_reviewadmin)
        cy.get('#form-control-agenda_kegiatan\\.3\\.waktu_mulai').type(go.tglawal_penguumanadmin)
        cy.get('#form-control-agenda_kegiatan\\.4\\.waktu_mulai').type(go.tglawal_reviewproposal)
        cy.get('#form-control-agenda_kegiatan\\.4\\.waktu_selesai').type(go.tglakhir_reviewproposal)
        cy.get('#form-control-agenda_kegiatan\\.7\\.waktu_mulai').type(go.tglawal_lolospendanaan)
        cy.get('#form-control-agenda_kegiatan\\.8\\.waktu_mulai').type(go.tglawal_pelaksanaan)
        cy.get('#form-control-agenda_kegiatan\\.8\\.waktu_selesai').type(go.tglakhir_pelaksanaan)
        cy.get('#form-control-agenda_kegiatan\\.9\\.waktu_mulai').type(go.tglawal_report)
        cy.get('#form-control-agenda_kegiatan\\.9\\.waktu_selesai').type(go.tglakhir_report)
        cy.get('#form-control-agenda_kegiatan\\.11\\.waktu_mulai').type(go.tglawal_ouput)
        cy.get('#form-control-agenda_kegiatan\\.11\\.waktu_selesai').type(go.tglakhir_output)
